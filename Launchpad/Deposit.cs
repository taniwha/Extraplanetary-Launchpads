...
namespace Kethane
{
    ...
    public class Blast
    {
        ...
        public Blast(float Lat, float Lon)
        {
            lat = Lat;
            lon = Lon;
        }
	...
	[Serializable]
	public class KethaneDeposit : Deposit
	{
	}
	
	[Serializable]
	public class OreDeposit : Deposit
	{
	}
    ...
    public class KethaneDeposits
    {
        ...
        public Deposit GetDepositOver(Vector3 Point)
        {
            foreach (Deposit KD in Deposits)
                if (KD.Shape.PointInPolygon(Point))
                    return KD;
	...
	/*[Serializable]
	public class OreDeposits : KethaneDeposits
	{
		private string Name;
		public OreDeposits(CelestialBody CBody) : base (CBody)
        {
            Width = 2.0f * (float)Math.PI * (float)CBody.Radius;
            Height = Width / 2.0f;
            Name = CBody.name;
